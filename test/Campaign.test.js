...
describe('Campaign', () => {
    ...
    .send({from:accounts[0],gas:'10000000'});
        ...
        await factory.methods.getDeployedCampaigns().call().then(address => {
    ...
    it('allows a manager to make a payment request', async () => {
        ...
        .createRequest('Buy clothes','100',accounts[1])
        .send({
            from:accounts[0],
            gas:'1000000'});
    ...
    it('processes requests', async () => {
        ...
        // ganache initialise each account with 100 ether each time a transation occurs
        await campaign.methods.contribute().send({
            from:accounts[0],
